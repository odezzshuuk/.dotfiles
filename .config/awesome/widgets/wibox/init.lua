...
local right_widgets = {
  ...
  pl(require("topbar.clock"), true, "calendar"),
  pl(require("topbar.capslock"), true, "capslock"),
  pl(require("topbar.idle-shutdown-ring").new(), true, "idle_shutdown"),
  pl(require("topbar.uptime_widget"), true, "uptime_widget"),
  pl((require("topbar.redshift")), true, "redshift"),
  pl((require("topbar.cpu")), true, "cpu_widget"),

  --pl((require("widgets.topbar.cpufreq")), true, "cpufreq"),
  pl((require("topbar.temp")), false, "temp"),
  pl((require("topbar.memory")), true, "mem"),
  pl((require("topbar.disk")), true, "fs"),
  pl((require("topbar.network")), true, "net_new"),
  pl((require("topbar.uptime")), true, "uptime"),
  pl((require("topbar.volume")), true, "volume_new"),
  --pl((require("widgets.topbar.aws")), true, "aws"),
  --require("widgets.topbar.aws"),
  pl((require("topbar.pacman")), true, "pacman"),
  --pl(top_left, true, ""),
  --gpick,
  --pl((require("widgets.topbar.notification")), true, "notification"),
  wibox.container.margin((require("topbar.systray")), 3, 3, 3, 3),
}
...
local hr_spr = require("helper").hr_spr
local spr = require("helper").spr
...
function M.get(screen)
  ...
  if madhur.helpers.is_portrait(screen) then
    right_widgets = right_widgets_vertical
  end

  local layout_box = require("layout_box").get(screen)
  local tag_list = require("tag_list").get(screen)
  local task_list = require("task_list").get(screen)
  local jgmenu = require("topbar.jgmenu")
  awful.util.mytasklist = task_list
