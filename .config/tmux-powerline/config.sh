...
# claude_code.sh {
	...
	# export TMUX_POWERLINE_SEG_CLAUDE_CODE_CREDENTIALS_FILE="/home/odezzshog/.claude/.credentials.json"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/odezzshog/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/odezzshog"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/odezzshog/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/odezzshog/.now_playing.log"
...
# tmux_continuum_save.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/home/odezzshog/.tmux/plugins//tmux-continuum"
# }
...
# weather.sh {
	...
	#   rm "/tmp/tmux-powerline_odezzshog/tmux-powerline/weather_cache_data.txt"
